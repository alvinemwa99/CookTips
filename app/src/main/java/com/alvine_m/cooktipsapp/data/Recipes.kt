...
import com.alvine_m.cooktipsapp.R

val defaultRecipes= listOf(
    Recipe(
        imageResource = R.drawable.noodle ,
        title = "Ramen",
        ingredients = listOf(
            "Noodles", "Eggs", "Mushrooms", "Carrots",
            "Soy sauce"),
        description = "Japan’s famous noodles-and-broth dish." +
                " It’s meant to be slurped LOUDLY."
    ),
